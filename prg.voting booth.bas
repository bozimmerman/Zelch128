!--------------------------------------------------
!- Tuesday, May 16, 2017 10:32:23 PM
!- Import of : 
...
31100 IFSY$<>"+"ORMID$(U$(8),4,1)="1"THENGOSUB36000
...
35000 GOSUB990:W0$=LEFT$(SY$,1):W1=VAL(SY$):IFW0$="#"THENW1=VAL(MID$(SY$,2))
...
36015 C$=CHR$(20)+R$:GOSUB32:IFI=2THENO$=A$:GOSUB9:RETURN
36020 FORX=1TO28:O$=CHR$(20):GOSUB9:NEXTX:O$=" Toggle: {ct c}":GOSUB4:X=26:GOSUB16:IFI$=""THENRETURN
36030 FORX=1TOLEN(I$):A=ASC(MID$(I$,X,1))-192:IFA<1ORA>26THENA=ASC(MID$(I$,X,1))-64:IFA<1ORA>26THEN36050
