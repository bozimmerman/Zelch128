!--------------------------------------------------
!- Saturday, August 13, 2016 1:39:37 PM
!- Import of : 
!- c:\tmp\newproject\bbs.create.prg
...
10500 CLOSE3:PRINT"{cyan}{clear}{down}Creating: {white}"+CHR$(13)+CHR$(34)+MID$(I$,2)+CHR$(34):FF$=MID$(I$,2):PRINT#15,"s"+MID$(STR$(D1),2)+":"+FF$
