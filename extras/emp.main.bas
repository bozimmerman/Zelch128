...
1140 GR=GR-GA
1150 DN=INT(RND(0)*(SF/10)+30):BB=INT(RND(0)*(SF/12)+10):PM=(INT(RND(0)*(SF/15)+10)):AF=0
...
1230 TP=BB+PM-PZ-DN:KG$="Gained":IFTP<0THENKG$="Lost  "
1240 SF=SF+TP:SF=SF*ABS(SF>.)
1250 PRINT"{black}Serfs Starved .......{white}"STR$(PZ)"{ct k}{black}Babies Born .........{white}"STR$(BB)"{ct k}{black}Peons Died ..........{white}"STR$(DN)"{ct k}{black}People Immigrated ...{white}"STR$(PM)
