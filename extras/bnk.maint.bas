!--------------------------------------------------
!- Saturday, May 20, 2017 1:33:34 AM
!- Import of : 
!- c:\src\zelch128\extras\bnk.maint.prg
!- Unknown Machine
!--------------------------------------------------
...
30040 REM ******************************************************************
30050 O$="Bank Maint...":GOSUB250:U1=U:D1=D:FORI=1TO50:VT(I)=0:VT$(I)="":NEXT:W9$="":FORI=0TO14:W9$=W9$+" 0"+R$:NEXTI
30060 OPEN2,U1,2,MID$(STR$(D1),2)+":bnk.records"
30070 ##################2,1:FORI=1TO7:SYS8222:VT(40+I)=VAL(I$):NEXTI:CLOSE2:W1=1:GOTO30999
30500 A$="":FORI=1TO11:SYS8222:A$=A$+I$+R$:NEXTI
30540 SYS8222:Y=VAL(I$)+Y:A$=A$+STR$(Y)+R$
30550 REM THIS LINE IS GONE NOW
30560 FORI=13TO18:SYS8222:A$=A$+I$+R$:NEXT:RETURN
30999 OPEN2,U1,2,MID$(STR$(D1),2)+":bnk.accounts"
31000 IFUI$(W1)=""THENCLOSE2:I$="prg.monster":U=D(0,0):D=D(0,1):GOTO23
31010 IFUI$(W1)="^"THEN##################2,W1:##################2,W1:PRINT#2,W9$:W1=W1+1:GOTO31000
31020 ##################2,W1:FORI=0TO14:SYS8222:VT$(I)=I$:VT(I)=VAL(I$):NEXTI:W0=0
...
32060 IFVT(5)=0THEN##################2,W1:Y=-VT(6):GOSUB30500:IFY>=VT(6)THEN##################2,W1:##################2,W1:PRINT#2,A$:ELSEIFVT(5)=0THENVT$(4)="0":VT(4)=0:GOTO32200
...
32090 ##################2,W2:Y=VT(6):GOSUB30500:##################2,W2:PRINT#2,A$
...
16962 BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBFORIFVT(9)>0ANDVT(10)=4ANDVT(2)>=VT(9)THENVT(2)=VT(2)-VT(9):VT$(2)=STR$(VT(2)):GOSUB33010
33100 IFVT(9)=0THEN33130:ELSEW0=W0OR2:CLOSE2:OPEN2,D(4,0),2,MID$(STR$(D(4,1)),2)+":sys.userfiles":##################2,W1:Y=-INT(VT(9)):GOSUB30500
33110 IFY>=INT(VT(9))THEN##################2,W1:PRINT#2,A$:GOSUB33010
33120 CLOSE2
...
33150 W0=W0OR2:CLOSE2:OPEN2,U1,2,MID$(STR$(D1),2)+":bnk.records":Y=1:DO:Y=Y+1:##################2,Y:SYS8222:LOOPUNTILI$="^"ORI$="{pound}":##################2,Y
33160 PRINT#2,STR$(W1)+R$+STR$(-INT(VT(8)-VAL(MID$(STR$(VT(10)),3)))):CLOSE2:VT$(8)="0":VT(8)=0:OPEN2,D(4,0),2,MID$(STR$(D(4,1)),2)+":sys.userfiles"
33170 ##################2,W1:SYS8222:SYS8222:SYS8222:CLOSE2:OPEN1,U1,15:OPEN2,U1,2,MID$(STR$(D1),2)+":bnk.blacklist,s,w":INPUT#1,E
33180 IFE>0THENCLOSE2:OPEN2,U1,2,MID$(STR$(D1),2)+":bnk.blacklist,s,a"
33190 PRINT#2,I$:CLOSE2:CLOSE1
45232 ORORORORORORORORORORORORORORORORORORORORORORORORORORORORORORORORORORORORORORORORORORORORORORORORORORORORORORORORORORORORORORORORORORORORORORORFORIFVAL(MID$(VT$(10),3))>=VT(8)THENVT$(8)="0":VT$(9)="0":VT$(10)="0":VT$(11)="0":VT(0)=VT(0)+VT(8):VT$(0)=STR$(VT(0))
34000 IFVT(12)=0THEN3
