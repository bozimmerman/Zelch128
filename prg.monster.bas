...
30670 LOOPUNTILW7=0:IFLEFT$(W1$,1)>"8"THENW1$="19"+W1$:ELSEW1$="20"+W1$
...
30710 RECORD#2,W1:FORI=1TO6:SYS8222:NEXTI:A$=I$:IFLEFT$(A$,1)>"8"THENA$="19"+A$:ELSEA$="20"+A$
30715 FORI=1TO2:SYS8222:NEXTI:IFLEFT$(A$,8)>W1$ORMID$(I$,3,1)="1"THENW1=W1+1:GOTO30690
...
30815 IFLEFT$(O$(2),1)>"8"THENW2$="19"+O$(2):ELSEW2$="20"+O$(2)
...
30875 IFLEFT$(I$,1)>"8"THENI$="19"+I$:ELSEI$="20"+I$
30880 IFW2$>I$THENSYS8222:SYS8213:P0$(P0)="Stomped "+F$+" #"+STR$(X+1)+"/{f5}"+I$+"{f5}":P0=P0+1:GOTO30870
