...
32530 RESTORE32550:FORW4=1TO9:READA,W6,W6$,W7,W8:IFVT$(0)<>"{sh @}"ANDW4>2THEN32540
32532 DO:L=W6:O$=W6$:GOSUB30100:IFA=5THENW8=VAL(VT$(4))
32535 LOOPUNTIL(I>=W7ANDI<=W8)
32540 NEXTW4:IFVT$(0)<>"{sh @}"THEN32650
32550 DATA 1,2,"Device number",8,31,2,50,"LU/Drive     ",0,255,3,2,"Max msgs (50)",1,50,4,2,"Max responses",1,999,5,2,"Min responses",1,999
...
33520 RESTORE33550:FORW4=1TO9:READA,W6,W6$,W7,W8:IF(VT$(0)="$"ANDW4>4)OR(VT$(0)="0"ANDW4>7)THEN33540
33530 DO:L=W6:O$=W6$:GOSUB30100:LOOPUNTIL(I>=W7ANDI<=W8)
33540 NEXTW4:IFVT$(3)=""THENVT$(3)="*"
33550 DATA 4,2,"Device number",8,31,5,50,"LU/Drive     ",0,255,3,15,"Access masks ",0,9E9,10,15,"SubOp ID#s   ",0,500,6,3,"Max Files    ",0,999
