!--------------------------------------------------
!- Tuesday, May 16, 2017 10:27:29 PM
!- Import of : 
...
751 SY(4)=0:SY$(1)="":IFO(20)=0THENRETURN:ELSEO$=T$(88):GOSUB4:I$="prg.online utils":U=D(0,0):D=D(0,1):GOTO23
752 I$=F$:IFRIGHT$(F$,2)="/a"ANDPEEK(2829)THENF$=LEFT$(F$,LEN(F$)-2:RETURN:ELSERETURN
760 GOSUB990:IFSY(4)THENI=SY(4):SY(4)=0:RETURN:ELSEIFLEFT$(SY$,1)="#"THENI=VAL(MID$(SY$,2)):GOTO765:ELSEI=ASC(SY$)-192
...
955 ON(W1-20)GOTO8690,8700,8730,8740,8750,8760,8770,8790,8810,8820,8860,8890,8900,8910,8920,8930,8990,9000,9030,9050,9100
...
1850 IFO(19)<>2THEN1100:ELSEGOSUB1170:O$="{white}":GOSUB9:IFE=1THEN1100:ELSEIFW1=1ORY<1THENY=L-1
...
8010 GOSUB990:IFSY$="*"THENO$=T$(3):GOSUB4:POKE2895,1:POKE2847,2:GOSUB10:U=I:GOTO8020:IFI<8ORI>30THENU=8:GOTO8020
