!--------------------------------------------------
!- Saturday, August 13, 2016 1:40:54 PM
!- Import of : 
!- c:\tmp\newproject\bbs.editor.prg
...
5810 PRINT"{down}Saving...";:OPEN2,X,2,STR$(Y)+":sys.misc data":RECORD#2,2:A$="":FORX=1TO10:A$=A$+F$(X)+CHR$(13):NEXTX
...
5910 PRINT"{down}Loading...";:OPEN2,X,2,STR$(Y)+":sys.misc data":RECORD#2,2:FORX=1TO10:SYS8222:F$(X)=I$
