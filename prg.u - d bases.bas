!--------------------------------------------------
!- Saturday, August 13, 2016 1:48:33 PM
!- Import of : 
!- c:\tmp\newproject\prg.u - d bases.prg
...
30510 IFSY$<>"*"ANDSY$<>"#"THENI$=SY$:GOTO30580
...
30550 NEXTI:F$=I$:IFF$=""THEN30680:ELSEIFD1=0ORVAL(I$)=0ORUB$(5)<>"{sh @}"THEN30580
30560 OPEN1,D(8,0),15:GOSUB30070:INPUT#1,E:IFETHEN30680:ELSERECORD#2,VAL(I$):C=ST:IFC=0THENSYS8222:F$=I$:SYS8222:Y=INSTR("psw",I$):CLOSE2:CLOSE1
30570 IF(C)ORF$="{pound}"ORF$="^"THENF$="":GOTO30680:ELSE30680
30580 FORI=1TOLEN(I$):A=ASC(MID$(I$,I,1)):IFA>192ANDA<219THENMID$(I$,I,1)=CHR$(AAND127)
30590 NEXTI
30600 F$=W1$+I$:IFD1=0THENGOSUB990:IFSY$<>"*"THENY=VAL(SY$):GOTO30660
