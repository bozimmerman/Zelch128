...
30030 E=0:IFDR$(1)=""ORU4=0ORASC(LEFT$(F$,1))<192THENE=-1:RETURN:ELSEA$=LEFT$(F$,1)
...
30045 NEXTX:IFA>U4ORY=0THENO$=T$(109):GOSUB4:E=1:A=0:Y=0:RETURN:ELSEM8$="":RETURN
30050 IFDR$(1)=""ORU4=0ORASC(LEFT$(F$,1))<192THENRETURN:ELSEGOSUB400:A$=LEFT$(F$,1):OPEN2,D(10,0),2,MID$(STR$(D(10,1)),2)+":sys.u/d desc"
30055 X=1:DO:A=INSTR(DR$(X),"."):IFATHENMID$(DR$(X),A,1)=A$:RECORD#2,X:PRINT#2,DR$(X):RECORD#2,((X-1)*120)+A+12:PRINT#2,F$+R$+STR$(ID)+R$+O$(3)+R$+M8$:EXIT
30060 X=X+1:LOOPUNTILX=13:CLOSE2:RETURN
30070 IFDR$(1)=""ORU4=0ORASC(LEFT$(F$,1))<192THENRETURN:ELSEA$=LEFT$(F$,1):OPEN2,D(10,0),2,MID$(STR$(D(10,1)),2)+":sys.u/d desc":X=1:DO:W7=INSTR(DR$(X),A$):A=W7
...
30100 GOSUB990:IFM3$<>"*"THENW1=ASC(M3$)-192:GOTO30300
30200 O$=T$(65):GOSUB4:DO:POKE2831,1:GOSUB8:LOOPUNTILA$=R$OR(ASC(A$)>192ANDASC(A$)<219):O$=A$:GOSUB4:IFA$=R$THEN920:ELSEW1=ASC(A$)-192
30300 GOSUB30020:RECORD#2,W1:FORI=1TO4:SYS8222:NEXTI:CLOSE2
30350 IFMID$(I$,ASC(U$(5))-192,1)="1"THENU1=W1:O$=O$(10)+":UD"+CHR$(U1+192):GOSUB7:GOSUB31200:GOTO940
...
31200 GOSUB30020:RECORD#2,U1:INPUT#2,D(8,0):INPUT#2,D(8,1):SYS8222:M6$=I$:SYS8222:SYS8222:U2$=I$:M7$=CHR$(192+U1)
31250 IFMID$(U$(8),4,1)="1"ORINSTR(";"+U2$+";",";"+MID$(STR$(ID),2)+";")THENU2$="{sh @}":ELSEU2$=""
31300 SYS8222:U2=VAL(I$):SYS8222:U3=VAL(I$):SYS8222:U4=VAL(I$):CLOSE2:O$=T$(67):GOSUB4:F$="sys.u/d "+CHR$(U1+64)+" title":U=D(8,0):D=D(8,1):GOSUB26:RETURN
31400 W2=16:GOSUB990:W1$="":E=0:IFM3$="#"THENW2=15:W1$=CHR$(U1+192):E=1:U=D(8,0):D=D(8,1):FORI=1TO3:GOSUB990:NEXT:GOTO31450:ELSEIFM3$<>"*"THENI$=M3$:GOTO31500
31450 O$=T$(68):GOSUB4:X=W2:GOSUB5:FORI=1TO6:IFINSTR(I$,MID$("*?:,$"+CHR$(34),I,1))THENI$=""
31470 NEXTI:IFI$=""THENF$="":Y=4:GOTO31800
31500 FORI=1TOLEN(I$):A$=MID$(I$,I,1):IFASC(A$)>192ANDASC(A$)<219THENMID$(I$,I,1)=CHR$(ASC(A$)AND127)
31550 NEXTI:F$=W1$+I$
31600 IFE=0THENGOSUB990:IFM3$<>"*"THENY=VAL(M3$):GOTO31700
31650 O$=T$(69):GOSUB4:C$="PSW"+R$:GOSUB28:O$=A$:GOSUB4:Y=I:IFI=4THEN31800
31700 IFETHEN31800:ELSEGOSUB8010
31800 I=Y:E=0:RETURN
31900 GOSUB990:IFM3$<>"*"THENGOSUB990:GOSUB990:U=D(8,0):D=D(8,1):I$=CHR$(192+U1):RETURN:ELSEGOSUB990:U=VAL(M3$):GOSUB990:D=VAL(M3$):I$="":RETURN
...
32150 GOSUB30030:IFE>0THEN920:ELSEIFE=0THENO$=T$(110):GOSUB4:X=80:GOSUB5:M8$=I$
...
32300 GOSUB32050:W2=PEEK(2856)+256*PEEK(2857):CLOSE2:IFW1>0ANDW2>U2THENU(1)=INT(U(1)+(W1*U3)):GOSUB30050:GOTO32500
...
33700 GOSUB32050:W2=PEEK(2856)+256*PEEK(2857):CLOSE2:IFW1>0ANDW2>U2THENU(1)=INT(U(1)+(W1*U3)):GOSUB30050:GOTO33100:ELSE32400
...
34100 O$="{cyan}"+W5$+" {white}(Y/N/D/A)? {ct c}":GOSUB4:C$="YNDA":GOSUB28:O$=A$:GOSUB4:ONIGOTO34200,34000:GOTO34350
...
36000 GOSUB990:A=VAL(M3$):IFM3$="*"ORM3$="#"THEN36100
...
36030 GOTO940
36100 IFM3$="#"THENA=ABS(O(19)-1):GOTO36010
36110 IFM3$="*"THENO$=T$(116):GOSUB4
36120 C$="PX"+R$:GOSUB28:O$=A$:GOSUB4:IFI=3THEN920:ELSEA=I-1:GOTO36010
37000 IFDR$(1)=""THEN920:ELSEO$=T$(117):GOSUB4:FORI=0TO200:TT$(I)="":NEXTI:W0=U1:W9=U4
37010 OPEN3,D(1,0),3,MID$(STR$(D(1,1)),2)+":sys.u/d bases":U1=1
37050 RECORD#3,U1:W1$=CHR$(192+U1):L=1:INPUT#3,I$:IFVAL(I$)<8THEN37500
37055 U=VAL(I$):INPUT#3,D:INPUT#3,I$:INPUT#3,I$:IFVAL(I$)=0THEN37500
37057 FORI=1TO4:INPUT#3,I$:NEXTI:U4=VAL(I$):IFU4=0THEN37500
...
37210 TT$(Y)="":NEXTY
37500 U1=U1+1:IFU1<27THEN37050:ELSECLOSE2:CLOSE3:FORI=0TO200:TT$(I)="":NEXTI:A=FRE(1):L=0:U1=W0:U4=W9:GOTO940
38000 IFDR$(1)=""ORU4=0THEN920:ELSEW1$=CHR$(U1+192):U=D(8,0):D=D(8,1):X=1:O$="":GOSUB4
