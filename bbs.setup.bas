!--------------------------------------------------
!- Tuesday, May 16, 2017 10:28:14 PM
!- Import of : 
...
30020 DIMP0$(101),U$(10),U(8),D(12,1),M(30),TT$(501),UI$(500),M$(50,6),CD(26,3),MR(50),MN$(50),MX(50),O(30),O$(30),T$(200),PL(26),PL$(26),PH$(27,4),DR$(12)
30030 DIMVT(50),VT$(50),UB$(20),UB(20),MB$(20),MB(20),SY$(20),SY(20),GB$(50)
...
31150 FORI=0TO11:INPUT#2,D(I,0),D(I,1):NEXTI:SYS8222:O(25)=INSTR("UF",I$)-1:FORI=0TO18:INPUT#2,M(I):NEXT
31200 SYS8222:POKE2926,ASC(I$+CHR$(0)):SYS8222:O$(14)=I$:FORI=18TO22:SYS8222:O$(I)=I$:NEXTI:O$(23)="Punter":FORI=24TO25:SYS8222:O$(I)=I$:NEXTI
...
31400 CLOSE2:POKE2852,M(4):POKE2853,PEEK(56577)ANDM(4)
...
31950 A=0:DO:OPEN2,D(A,0),15:SYS8264:IFST=0THENPRINT#2,"t-ra":SYS8222
