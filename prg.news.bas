...
38200 O$=T$(123):GOSUB4:X=3:GOSUB16
...
38250 POKE2925,0:O$=CHR$(13)+"{black}{reverse off}press return:{ct c}":GOSUB4:POKE2925,M(3):GOSUB16:O$=CHR$(14)+CHR$(3):GOSUB4:GOTO940
38690 GOTO940
