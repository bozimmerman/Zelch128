...
37999 REM -------- VIEW LIBRARY FILE
38000 GOSUB990:W1$=SY$:IFSY$="*"THENGOSUB38700:GOTO38010:ELSEIFSY$="**"THENW1$="*"
38010 GOSUB8010
38020 W7$="":IFSY(4)>0THENW7$="{sh @}"
38030 W1=1:W9=26:GOSUB760:IFI<1ORI>26THEN920:ELSEW1=I:IFVAL(SY$)THENW7$="{sh @}":W9=50
...
38100 W0=W1:W3=-1:OPEN2,U,0,"$"+D$+":"+W1$:GET#2,A$:GET#2,A$:POKE253,0:POKE255,0:SYS8258:W8=0
...
38150 IFW8=1ORW1+1>W9THENW8=0:O$="{black}"+A$+") "+I$:GOSUB4:GOTO38180
38160 W8=1:O$="{black}"+A$+") "+I$:IFLEN(O$)<21THENO$=O$+LEFT$(SP$,21-LEN(O$))+"{ct c}":GOSUB4:ELSEW8=0:GOSUB4
38180 GOSUB8:W1=W1+1:LOOPUNTILW1>W9ORA$=" "
38190 CLOSE2:IFW0=W1THEN920
38200 O$=T$(123):GOSUB4:IFW9<27ANDW7$<>"{sh @}"THENGOSUB8:GOTO38210:ELSEX=3:GOSUB16
38210 IFI$=""THEN920:ELSEW3=ASC(I$)-192:IFVAL(I$)>0THENW3=VAL(I$)
38220 IFW3<W0ORW3>W1THEN920
38230 O$="{clear}{white}{reverse off}":GOSUB4
38240 OPEN2,U,2,D$+":"+VT$(W3)+",R":SYS8210:CLOSE2
38250 POKE2925,0:O$=CHR$(13)+"{black}{reverse off}press return:{ct c}":GOSUB4:POKE2925,M(3):GOSUB16:O$=CHR$(14)+CHR$(3):GOSUB4
38690 W1=W0:GOTO38100
38700 O$=T$(29):GOSUB4:POKE2847,16:POKE2895,1:GOSUB6:IFI$=""THENW1$="*":RETURN:ELSEW1$=I$:RETURN
39999 REM --------- I DONT KNOW
40000 IFF$=""THENRETURN:ELSEX=0:OPEN1,U,15,"s"+D$+":sys.work":GOSUB30020:INPUT#1,E:IFETHENCLOSE1:CLOSE2:RETURN
...
40500 INPUT#1,E:CLOSE3:CLOSE2:IFE>0THEN40700:ELSEPRINT#1,"s"+D$+":"+F$:PRINT#1,"r"+D$+":"+F$+"=sys.work"
40600 IFX=0THENPRINT#1,"s"+D$+":"+F$:CLOSE1:RETURN:ELSECLOSE1:RETURN
40700 O$="Disk error, clearing...":GOSUB4:PRINT#1,"s"+D$+":sys.work":PRINT#1,"v"+D$:CLOSE1:RETURN
...
51800 IFU<8THENU=D(1,0):D=D(1,1):D$=MID$(STR$(D),2):RETURN:ELSERETURN
