!--------------------------------------------------
!- Saturday, August 13, 2016 1:46:48 PM
!- Import of : 
!- c:\tmp\newproject\prg.msg bases.prg
...
32000 FORI=1TOMB(3):RECORD#2,W7+I:INPUT#2,MN$(I),MR(I):Y=Y+MR(I):IFMN$(I)>U$(6)THENX=X+1
...
35700 SYS8222:IFI$<=U$(6)ANDMB(11)THENSYS8213:MB(6)=MB(6)+1:GOTO35650
...
37500 IFMN$(MB(13))>U$(6)THENMB(5)=MB(13):GOSUB35000
...
44250 IFMN$(MB(13))>U$(6)THENMB(5)=MB(13):GOSUB40500
