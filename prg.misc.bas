!--------------------------------------------------
!- Tuesday, May 16, 2017 10:29:21 PM
!- Import of : 
...
30020 O$="{ct k}{black}Menu to edit: {ct c}":GOSUB4:GOSUB6:IFI$=""ORLEN(I$)>16THEN30020:ELSEO$(6)=I$:U=D(9,0):D=D(9,1):FORI=0TO50:FORY=0TO4:M$(I,Y)="":NEXTY:NEXTI
...
39715 C$=CHR$(20)+R$:GOSUB32:IFI=2THENO$=A$:GOSUB9:RETURN
39720 FORX=1TO28:O$=CHR$(20):GOSUB9:NEXTX:O$=" Toggle: {white}{ct c}":GOSUB4:X=26:GOSUB16:IFI$=""THENRETURN
...
44004 I=ASC(RIGHT$(I$,1))-192:I$=LEFT$(I$,LEN(I$)-1)
