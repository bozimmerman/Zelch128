!--------------------------------------------------
!- Saturday, August 13, 2016 1:47:35 PM
!- Import of : 
!- c:\tmp\newproject\prg.new user.prg
...
31500 U$(5)="A":U$(6)="9001010530":U$(9)="00000000000000000000000000":U(1)=M(10):U(2)=M(11):U(3)=BA:U$(10)="11111111111111111111111111"
